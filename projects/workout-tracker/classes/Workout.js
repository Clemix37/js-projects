    ...
    getTemplate(){
        return `
            <div class="ligne" style="padding: 5px;">
                <h3 class="subtitle"><i class="fas fa-dumbbell" style="margin-right: 8px; color: yellow;"></i>${this.#title}</h3>
            </div>
            <div class="ligne">
                <button data-id="${this.#id}" class="button is-info is-rounded ${Workout.CLASS_BTN_EDIT_WORKOUT}"><i class="fas fa-edit"></i></button>
                <button data-id="${this.#id}" class="button is-danger is-rounded ${Workout.CLASS_BTN_DELETE_WORKOUT}"><i class="fas fa-trash"></i></button>
            </div>
        `;
    }
