...
export default class Operation {
    ...
    getTemplate(){
        return `
            ...
            <div class="ligne">
                <button data-id="${this.#id}" class="button is-rounded is-info ${Operation.CLASS_BTN_EDIT}" title="Edit"><i class="fas fa-edit"></i></button>
                <button data-id="${this.#id}" class="button is-rounded is-danger ${Operation.CLASS_BTN_DELETE}" title="Delete"><i class="fas fa-trash"></i></button>
            </div>
        `;
    }
